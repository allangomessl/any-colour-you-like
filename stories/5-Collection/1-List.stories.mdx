...
import { Slot, List, Button, Row, Col, Avatar, Item } from 'universe-ui'
import { useState, useEffect, useCallback, useLayoutEffect } from 'react'
import { useGithub } from '../../samples/hooks'
import { GithubUserItem } from '../../samples/components'

<Meta title="Collection/List" component={List} />

# List

## Basic
<Preview>
  <Story name="Basic" h='200px'>
    <List items={['React', 'Vue.js', 'Angular']} />
  </Story>
</Preview>
...
## Custom Basic
<Preview>
  <Story name="Custom Basic" h='300px'>
    <List items={['React', 'Vue.js', 'Angular']}>
...
<Preview>
  <Story name="Server Side" h='500px'>
    {() => {
      const { data, loading, more, search } = useGithub()
      return (
        <List items={data} loading={loading} more={more} search={search}>
