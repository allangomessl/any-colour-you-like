...
export const useFlexProps = (elementName: string) => {
  ...
  const FlexProps = React.useCallback(() => {
    return (
      <Col fill gap='16px' padding='8px'>
        <Row align="center" gap={2} justify="center">
          <strong>Flex Props</strong>
        </Row>
        <strong>align:&nbsp;</strong>
        <Button.Choice inverted w='150px' selected={align}>
        ...
        <Button.Choice inverted w='150px' selected={justify}>
        ...
        <strong>gap:&nbsp;</strong>
        <Button.Choice inverted w='150px' selected={gap}>
        ...
        <Code h='120px'>
          <CodeBlock>{`
<${elementName} align='${align}' justify='${justify}' gap={${gap}}>
  {boxes}
</${elementName}>
          `}</CodeBlock>
        </Code>
